! function(t, n) {
    ...
    function st(t) {
        ...
        if (null == t.a || t.a >= 1) {
            var n = function(t) {
                ...
                i = n(t.g),
                o = n(t.b);
            return r(e) && r(i) && r(o) && (e = e.charAt(0), i = i.charAt(0), o = o.charAt(0)), "#" + e + i + o
        }
    ...
    function It(t, n, r) {
        var e = arguments.length > 3 && void 0 !== arguments[3] && arguments[3];
        if (Ft(n)) {
            if (Nt(r)) return _t(n, r.start, r, t, e)
        } else if (Ft(r)) {
            if (n.end) return _t(n, n.end, r, t, e)
        } else {
            if (n.end) return r.start ? Pt(n, n.end, r.start, r, t, e) : _t(n, n.end, r, t, e);
            if (r.start) return _t(n, r.start, r, t, e)
        }
        return At(n, r, t, e)
    }
...
(function(s, i, o, w) {
    ...
    "animations": [{
        ...
        "s": "MEDA1M2FmNTY5OGE5YTGY5NWE4OWRhM2EyNTYM2ZU42NjY0NjQ2NFU2HMDU2OTg5ZGE2OTk5ND2E4OWRQYTNhMjU2NmCU2NTYwNTY5ZGE4OTlUhNjk1YTg5ZGEzYTJhCNzU2NmU2NDYwNTY5YJUg5ZGEwYTA1NjZlNjMU2MDU2OTVhMGE4OTlThNmEyOTVhODk5NTY2IZTlhOTVDYTBhNzk5NUjA1NmE3YTQ5OTk5OTFg1NjZlNjViMQ|"
    }],
    "options": "MCDAxMDg4MmY4MFg4MTRZlN2Y4MTJmNDcyZjcI5RTdjNmU3MTJmOGE/B"
