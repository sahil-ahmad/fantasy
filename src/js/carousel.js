...
class Carousel {
    constructor(el) {
        ...
        this.carouselData = [{
                'id': '1',
                'src': 'images/Prediction_Portal_slider01.webp',
            },
            {
                'id': '2',
                'src': 'images/Prediction_Portal_slider02.webp',
            },
            {
                'id': '3',
                'src': 'images/Prediction_Portal_slider03.webp',
            },
            {
                'id': '4',
                'src': 'images/Prediction_Portal_slider04.webp',
            },
            {
                'id': '5',
                'src': 'images/Prediction_Portal_slider05.webp',
            }
        ];
